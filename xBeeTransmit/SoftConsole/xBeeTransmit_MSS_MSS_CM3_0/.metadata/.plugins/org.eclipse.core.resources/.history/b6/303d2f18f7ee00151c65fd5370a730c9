...
BUILDCMD = arm-none-eabi-gcc -mthumb -mcpu=cortex-m3  -L"C:\Users\Ben\Desktop\xBeeTransmit\SoftConsole\xBeeTransmit_MSS_MSS_CM3_0\xBeeTransmit_MSS_MSS_CM3_0_hw_platform\Debug" -T../../xBeeTransmit_MSS_MSS_CM3_0_hw_platform/CMSIS/startup_gcc/debug-in-actel-smartfusion-esram.ld -Wl,-Map=$(EXECUTABLE).map -Xlinker -gc-sections 
SHELL := cmd.exe
EXECUTABLE := xBeeTransmit_MSS_MSS_CM3_0_app
